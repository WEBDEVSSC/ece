...
@section('content_header')
    <h1><strong>Laboratorios</strong> <small class="text-muted">Detalles</small></h1>
@stop
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-11">
                        <h4 class="mb-1 font-weight-bold">
                            {{ $laboratorio->cita->paciente->nombre_completo }}
                        </h4>
                    </div>
                </div>
            </div>
...
<div class="card">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <p><strong>Glucosa Sérica</strong></p>
            {{ $laboratorio->glucosa_serica }}
        </div>

        <div class="col-md-2">
            <p><strong>Triglicéridos</strong></p>
            {{ $laboratorio->trigliceridos }}
        </div>

        <div class="col-md-2">
            <p><strong>Colesterol LDL</strong></p>
            {{ $laboratorio->colesterol_ldl }}
        </div>

        <div class="col-md-2">
            <p><strong>Colesterol HDL</strong></p>
            {{ $laboratorio->colesterol_hdl }}
        </div>
