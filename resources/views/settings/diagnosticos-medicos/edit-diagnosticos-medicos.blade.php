...
@section('title', 'Editar Diagnóstico Médico')
    ...
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                ...
                <p class="text-muted small mb-0">Actualice la información del diagnóstico médico seleccionado</p>
            </div>
...
<div class="container-fluid">
    ...
    <form action="{{ route('diagnosticosMedicosUpdate', $diagnostico->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="card card-outline card-primary shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3">
                <h3 class="card-title text-bold text-dark mb-0" style="font-size: 1.1rem;">
                    ...
                    Modificar Datos del Diagnóstico Médico
                </h3>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $diagnostico->nombre) }}" placeholder="Ej. Diabetes Mellitus Tipo 2, Hipertensión...">
                        @error('nombre')
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="tipo_unidad" id="tipo_unidad" class="form-control @error('tipo_unidad') is-invalid @enderror" value="{{ old('tipo_unidad', $diagnostico->tipo_unidad) }}" readonly>
                        @error('tipo_unidad')
                            <small class="text-danger font-weight-bold d-block mt-1">{{ $message }}</small>
                        @enderror
                    </div>
