        ...
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark font-weight-bold" style="font-size: 1.6rem;">
                    Nuevo Registro de Rol
                </h1>
                <p class="text-muted small mb-0">Complete la información solicitada para dar de alta un nuevo rol en el sistema</p>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="rol" id="rol" class="form-control @error('rol') is-invalid @enderror" value="{{ old('rol') }}" placeholder="Ej. Administrador, Médico...">
                        @error('rol')
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="descripcion" id="descripcion" class="form-control @error('descripcion') is-invalid @enderror" value="{{ old('descripcion') }}" placeholder="Breve descripción del alcance del rol">
                        @error('descripcion')
                            <small class="text-danger font-weight-bold d-block mt-1">{{ $message }}</small>
                        @enderror
                    </div>
