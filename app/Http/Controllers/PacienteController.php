...
class PacienteController extends Controller
{
    ...
    public function pacientesStore(Request $request)
    {
        ...
        $paciente->no_derechohabiencia  = $request->no_derechohabiencia ;
    ...
    public function pacientesUpdate(Request $request, String $id)
    {
        ...
        return redirect()->route('pacientesIndex')->with('success', 'Registro actualizado correctamente');
    }
    ...
    public function pacientesDXMedicoCreate(String $id)
    {
        ...
        $dxs = CatDiagnosticosMedicos::all();

        return view('pacientes.create-diagnostico-medico', compact('paciente','diagnosticos','dxs'));
    }
    ...
    public function pacientesDXMedicoStore(Request $request, String $id)
    {
        $request->validate([
            ...
            'dx_id' => 'required|exists:cat_diagnosticos_medicos,id',
        ],[
            ...
            'dx_id.required' => 'Debe seleccionar un diagnóstico médico.',
            'dx_id.exists'   => 'El diagnóstico médico seleccionado no es válido.',
        ]);

        $paciente = Paciente::findOrFail($id);

        $paciente->diagnostico_medico_id = $request->diagnostico_medico_id;
        $paciente->dx_id = $request->dx_id;
